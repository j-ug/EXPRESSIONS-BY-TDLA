...
export const BOTANICAL_ARTWORKS: BotanicalArtwork[] = [
  ...
  },
  {
    ...
    inspiration: 'The sun-drenched drylands and red laterite soil plains surrounding Tiruchy, where palmyra groves stand as ancient sentries against the wind.',
    panelPosition: 'above',
